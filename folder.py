...
def main(aId, aLocation):
    ...
    while i<3:
        ...
        out_file = None
        if args.input != 'cam':
            out_filename = os.path.splitext(file)[0] + '_output.mp4'
            ...
            if exec_net.requests[cur_request_id].wait(-1) == 0:
                ...
                if(len(head_elements_y_pos) > 0):
                    ...
                    if (
                        ...
                        if(Fall_Confidence==0):
                            Fall_Confidence = head_avg_position - previous_head_avg_position
                        else:
                            Fall_Confidence = (Fall_Confidence + (head_avg_position - previous_head_avg_position))/i
